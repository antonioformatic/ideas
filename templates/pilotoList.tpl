...
<table border="0" >
	...
	<th bgcolor="#d1d1d1">Dirección</th>
	<th bgcolor="#d1d1d1">Telefono</th>
	<th bgcolor="#d1d1d1">Correo eletrónico</th>
	<th bgcolor="#d1d1d1">Fecha de nacimiento</th>
    ...
    <tr bgcolor="{cycle values="#dedede,#eeeeee" advance=true}">
		...
		<td>
			{$record.fecha_de_nacimiento|escape}
		</td>        
		<td>
...
<table border="0">
	<tr>
		...
		<td>
			<a href="{$SCRIPT_NAME}?action=add&view=piloto">
				<button>+</button></a>
			</a>
		</td>
	</tr>
